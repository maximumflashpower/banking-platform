  ...
  try {
    const payload = {
      ...
      idempotencyKey:
        ...
        null,
      requestId: req.requestContext?.requestId || req.header('X-Request-Id') || null,
      correlationId: req.requestContext?.correlationId || req.header('X-Correlation-Id') || null,
      ...
      testDelayMs:
        req.body.testDelayMs === undefined && req.body.test_delay_ms === undefined
          ? null
          : Number(req.body.testDelayMs ?? req.body.test_delay_ms),
      testForceError:
        req.body.testForceError === true || req.body.test_force_error === true,
